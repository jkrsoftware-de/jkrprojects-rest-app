package one.jkr.de.jkrprojects.jkrprojects.rest.app.my.worklife.system.subsystems.application.chapter.management.adapters.in.web;
...
import one.jkr.de.jkrprojects.jkrprojects.rest.app.my.worklife.system.subsystems.application.chapter.management.adapters.in.web.payload.data.classes.create.application.chapter.request.CreateApplicationChapterRequestPayload;
import one.jkr.de.jkrprojects.jkrprojects.rest.app.my.worklife.system.subsystems.application.chapter.management.adapters.in.web.payload.data.classes.create.application.chapter.response.CreateApplicationChapterResponsePayload;
import one.jkr.de.jkrprojects.jkrprojects.rest.app.my.worklife.system.subsystems.application.chapter.management.adapters.in.web.payload.data.classes.get.presigned.url.response.GetPresignedUrlResponsePayload;
...
public class ApplicationChapterManagementRestController {
    ...
    public ResponseEntity<?> updateApplicationChapter(@RequestHeader("Authorization") @NonNull String authorizationHeader,
                                                      ...
                                                      @RequestBody @NonNull UpdatePredefinedOrderNumberOfApplicationChapterRequestPayload payload) throws NoAuthorizationRestException {
        internalAuthorizationSystemAdapterForRestControllers.checkSystemClientAuthorization(authorizationHeader);
